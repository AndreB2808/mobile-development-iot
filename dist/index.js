...
const consulta2 = criarConsulta(2, medico2, paciente2, new Date(), 250);
const consulta3 = criarConsulta(3, medico3, paciente3, new Date(), 450);
const consulta4 = criarConsulta(4, medico4, paciente2, new Date(), 150);
const consulta5 = criarConsulta(5, medico5, paciente1, new Date(), 650);
